...
contract Predicate is AccessControlMixin, ITokenPredicate {
    /**
     * ERC20Predicate Related State Variables
     */
    ...
    /**
     * ERC20Predicate Related Functions
     */
    /**
     ...
     */
    function exitTokens(address, address rootToken, bytes memory log) public override only(MANAGER_ROLE) {
