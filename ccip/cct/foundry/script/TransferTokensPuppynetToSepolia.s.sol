...
contract TransferTokens is Script {
    ...
    function run() external {
        ...
        // Transfer the tokens to the Token Pool s.t. we don't get Burn Amount Exceeds Balance Error
        IERC20(tokenAddress).transfer(poolAddress, amount);

        // Prepare the CCIP message
        Client.EVM2AnyMessage memory message = Client.EVM2AnyMessage({
            receiver: abi.encode(0x78157C5Ca2e024D429A6b01E21caf542064a8De8), // Receiver address on the destination chain
